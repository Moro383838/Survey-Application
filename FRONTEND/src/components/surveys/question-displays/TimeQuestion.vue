<template>
    <div class="question-card">
      <div class="question-header">
        ...
        <h3 class="question-type-title">وقت</h3>
      </div>
          ...
          <div class="settings-list">
            <div class="setting-item">
              ...
              <span class="setting-value">
                {{ question.format || '24 ساعة' }}
              </span>
            </div>
            
            <div v-if="question.minTime" class="setting-item">
              <span class="setting-label">الوقت الأدنى</span>
              <span class="setting-value">
                {{ question.minTime }}
              </span>
            </div>
            
            <div v-if="question.maxTime" class="setting-item">
              <span class="setting-label">الوقت الأقصى</span>
              <span class="setting-value">
                {{ question.maxTime }}
              </span>
            </div>
