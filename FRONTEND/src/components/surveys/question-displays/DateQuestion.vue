<template>
    <div class="question-card">
      <div class="question-header">
        ...
        <h3 class="question-type-title">تاريخ</h3>
      </div>
      ...
      <div class="question-content">
        ...
        <div class="settings-section">
          ...
          <div class="settings-list">
            ...
            <div v-if="question.minDate" class="setting-item">
              <span class="setting-label">تاريخ البداية</span>
              <span class="setting-value">
                {{ question.minDate }}
              </span>
            </div>
            
            <div v-if="question.maxDate" class="setting-item">
              <span class="setting-label">تاريخ النهاية</span>
              <span class="setting-value">
                {{ question.maxDate }}
              </span>
            </div>
