...
.sidebar-header { padding: 20px; background: var(--primary-dark); border-bottom: 1px solid var(--primary-teal); color: white; }
...
.btn-primary { background: var(--primary-dark); color: white; border: none; }
